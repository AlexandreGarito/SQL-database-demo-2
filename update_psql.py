...
import pandas as pd
import sqlalchemy
from gcp_interactions import get_secret
...
SQL_DB_TABLE_NAME2 = get_secret(PROJECT_ID, "SQL_DB_TABLE_NAME2")
SQl_DB_TABLE_NAME3 = get_secret(PROJECT_ID, "SQL_DB_TABLE_NAME3")
